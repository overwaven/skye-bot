...
export const DEMO_AI_CATALOG: AiCatalog = {
  configured: true,
  chatId: 1,
  chats: [
    { chatId: 1, name: "Personal chat", type: "private" },
    { chatId: -100123, name: "Skye builders", type: "supergroup" },
  ],
  routing: {
    textModelId: "demo-text",
    imageGenerationModelId: "demo-image",
    imageEditModelId: "demo-image",
    ttsModelId: "demo-tts",
    sttModelId: "demo-stt",
    ttsVoice: "Aoede",
  },
  ...
  models: [
    {
      ...
      name: "Gemini Flash",
      upstreamId: "google/gemini-flash",
...
export const DEMO_PROVIDERS: ProviderAdminResponse = {
  onboardingRequired: false,
  defaults: DEMO_AI_CATALOG.defaults,
  providers: [
    {
      id: "openrouter",
      name: "OpenRouter",
      ...
      createdAt: "2026-08-13T00:00:00.000Z",
      updatedAt: "2026-08-13T00:00:00.000Z",
      models: DEMO_AI_CATALOG.models.filter(
